...
(function () {
    ...
    function gerenciarQuadrosOriginais() {
        ...
        if (!board) {
            ...
            itemEstoque = document.createElement('div');
            ...
            itemEstoque = board.querySelector('.notification-item');
        }

        if (itemEstoque) itemEstoque.style.display = NOTIFICATIONS_CONFIG.estoque.enabled ? 'flex' : 'none';
        board.style.display = NOTIFICATIONS_CONFIG.estoque.enabled ? 'flex' : 'none';
    }
